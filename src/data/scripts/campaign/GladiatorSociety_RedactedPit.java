...
public class GladiatorSociety_RedactedPit {
    ...
    private static final String[] RING_CACHE_TYPES = {
        ...
        Entities.WEAPONS_CACHE, Entities.WEAPONS_CACHE_LOW, Entities.WEAPONS_CACHE_REMNANT,
        ...
        for (int i = 0; i < count; i++) {
            try {
                ...
                if (cache != null) {
                    ...
                    cache.setCircularOrbit(focus, angle, dist, 300f + rand.nextFloat() * 200f);
                }
            } catch (Throwable t) { LOG.warn("GS Redacted Pit: Could not add cache at ring " + orbitRadius, t); }
        }
    }
